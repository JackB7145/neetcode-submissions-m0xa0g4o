class NumMatrix:
    ...
    def sumRegion(self, row1: int, col1: int, row2: int, col2: int) -> int:
        ...
        print('##################')
        print(f'Input: row1: {row1}, col1: {col1}, row2: {row2}, col2: {col2}')
        print(f'Total: {total}')
        print(f'Top Segment: {topSegment}')
        print(f'Left Segment: {leftSegment}')
        print(f'Left Adjusted Segment: {adjustedLeftSegment}')
